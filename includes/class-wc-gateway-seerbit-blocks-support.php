...
final class WC_Gateway_Seerbit_Blocks_Support extends AbstractPaymentMethodType {
	...
	public function is_active() {
		...
		return $payment_gateways['seerbit']->is_available();
	}
	...
	public function get_payment_method_script_handles() {
		$script_asset_path = plugins_url( '/assets/js/blocks/frontend/blocks.asset.php', WC_SEERBIT_MAIN_FILE );
		...
		$script_url = plugins_url( '/assets/js/blocks/frontend/blocks.js', WC_SEERBIT_MAIN_FILE );
		...
		if ( function_exists( 'wp_set_script_translations' ) ) {
			wp_set_script_translations( 'wc-seerbit-blocks', 'woo-seerbit', );
		}

		return array( 'wc-seerbit-blocks' );
	}
	...
	public function get_payment_method_data() {
		$payment_gateways_class = WC()->payment_gateways();
		$payment_gateways       = $payment_gateways_class->payment_gateways();
		$gateway                = $payment_gateways['seerbit'];
		...
		return array(
			...
			'logo_urls'         => array( $payment_gateways['seerbit']->get_logo_url() ),
		);
	}
	...
	public function failed_payment_notice( PaymentContext $context, PaymentResult &$result ) {
		if ( 'seerbit' === $context->payment_method ) {
			add_action(
				'wc_gateway_seerbit_process_payment_error',
